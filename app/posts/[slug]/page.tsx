import { getPostBySlug, getAllPostSlugs, getRelatedPosts, calculateReadingTime, formatDate } from "@/lib/posts";
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#fafafa]">
        ...
        <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16 lg:ml-80">
          {/* Categories */}
